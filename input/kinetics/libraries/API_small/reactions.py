...
name = "API_small"
shortDesc = u"API_small"
longDesc = u"""
This library is based on the RMG NOx2018 library taken from
...
Adaptations were made, primarily removal of PDep reactions, so this library can be used for liquid phase kinetics.
Removed reactions were left commented-out for reference.
"""
